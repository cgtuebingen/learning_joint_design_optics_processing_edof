...
LOGDIR = '/graphics/scratch/engelhar/train_logs/model_slm45k_2prop_no-psf_unet4_oryx'
...
EXPORT_PATH = '/graphics/scratch/engelhar/test_data/unet4_slm45k_2prop_no-psf_oryx'
...
class OutputSLM(Callback):
    ...
    def _after_train(self):
        for var in self.varlist:
            ...
            output = "./image_SLM45k_2prop_no-psf_unet4_oryx.png"
