...
LOGDIR = '/graphics/scratch/engelhar/train_logs/model_slm45k_2prop_unet4_oryx_d2_laplace'
...
EXPORT_PATH = '/graphics/scratch/engelhar/test_data/unet4_slm45k_2prop_oryx_d2_laplace'
...
class Model(ModelDesc):
    ...
    def _build_graph(self, inputs):
        ...
        regularizer = laplace_l1_regularizer(0.05)
        self.cost = tf.add(tf.reduce_mean(tf.squared_difference(prediction, expected), name="mse"),
                           tf.multiply(regularize_cost("a_slm", regularizer), reg), name='reg_mse')
...
class OutputSLM(Callback):
    ...
    def _after_train(self):
        for var in self.varlist:
            ...
            output = "./image_SLM45k_2prop_zo_unet4_oryx_d2.png"
...
def get_config():
    ...
    return TrainConfig(
        ...
        callbacks=[
            ...
            ScheduledHyperParamSetter('regularization_factor', [(20, 0.2), (50, 0.1), (90, 0.3)]),
