...
LOGDIR = '/graphics/scratch/engelhar/train_logs/model_slm45k_2prop_unet4_oryx_d2_l1-loss'
...
EXPORT_PATH = '/graphics/scratch/engelhar/test_data/unet4_slm45k_2prop_oryx_d2_l1-loss'
...
class Model(ModelDesc):
    ...
    def _build_graph(self, inputs):
        ...
        self.cost = tf.add(tf.reduce_mean(tf.abs(prediction - expected), name="mae"),
                           tf.multiply(regularize_cost("a_slm", regularizer), reg), name='reg_mae')
...
class OutputSLM(Callback):
    ...
    def _after_train(self):
        for var in self.varlist:
            ...
            output = "./image_SLM45k_2prop_zo_unet4_oryx_d2_l1-loss.png"
...
def get_config():
    ...
    return TrainConfig(
        ...
        callbacks=[
            ...
            InferenceRunner(dataset_val, [ScalarStats(['mae:0', 'psnr/prediction:0', 'psnr/ssim:0'])]),
        ...
        extra_callbacks=[
            ...
            ProgressBar(['mae:0', 'psnr/prediction:0']),
            MergeAllSummaries(),
            OutputSLM()
        ],
        model=Model(),
